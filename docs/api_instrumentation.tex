...
will return failure, as the fuzzing processes has not been started yet.
}{
\item instrumentation\_state - an instrumentation specific structure previously
created by the create() function
...
prior to \texttt{enable}, it will return failure, as the fuzzing processes has
...
\texttt{info} parameters prior to \texttt{enable}, it will return failure, as
the fuzzing processes has not been started yet.
}{
\item instrumentation\_state - an instrumentation specific structure previously
created by the create() function
...
is called prior to \texttt{enable}, it will return failure, as the fuzzing
