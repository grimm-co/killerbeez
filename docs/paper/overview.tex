...
Killerbeez is meant to be able to coordinate an entire distributed fuzzing
...
uninteresting ones, and dispatches jobs to worker nodes to be executed.  It also
provides a \REST{} \API{} that allows a researcher to trigger actions and
extract results manually if desired, or to integrate an external system that
