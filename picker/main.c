...
//recording instrumentation data on each of the loaded libraries. It then
//analyzes the instrumentation data for each library to determine which
//libraries the instrumentation data varies based on the input file.  These
