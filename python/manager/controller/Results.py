...
class ResultsCtrl(Resource):
    ...
    def list(self, offset=None, limit=None, job_id=None, repro_file=None):
        query = results.query
        if job_id:
            query = query.filter_by(job_id=job_id)
        if repro_file:
    ...
    def get(self, job_id=None):
        ...
        return self.list(args['offset'], args['limit'], job_id, args['repro_file'])
    ...
    def post(self, job_id):
        ...
        return self.create(job_id, parser.parse_args())
