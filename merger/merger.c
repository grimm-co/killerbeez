...
//tracked coverage from both instrumentation states. This allows multiple
//instances of the fuzzer to share instrumentation data, and ignore paths that
//the other fuzzer found.
